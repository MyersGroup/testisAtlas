...
download.file("ftp://ftp.ensembl.org/pub/release-92/fasta/mus_musculus/dna/Mus_musculus.GRCm38.dna_sm.primary_assembly.fa.gz","../data/motifs/promoter_sequences/Mus_musculus.GRCm38.dna_sm.primary_assembly.fa.gz")
...
saveRDS(cbind(HM11_regprobs,HM11_regprobs_extra), "../data/motifs/HocomocoV11_regprobs_matrix_core_and_extra.rds")
```
