...
X_escapees_plot <- ggplot(curve_data[melt_genes(genes)[!is.na(PseudoTime)], on="PseudoTime"], aes(-PseudoTime, Expression, group=Gene)) +
    stat_smooth(geom="line", method = "gam", formula = y ~ s(x, k = 35), se=FALSE, colour="black") +
...
pdf(width = 15, height = 10, file = "../results/Figure_2_MSCI.pdf")
plot_grid(left, right, ncol=2)
dev.off() 

pdf(width = 15, height = 9, file = "../results/Figure_2_Supplement.pdf")
