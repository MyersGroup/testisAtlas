...
aheatmap(t(results$loadings[[1]][,macrophage_genes]), breaks=0, Colv = NA, cexRow = 0.3, layout = "_*", main="(row scaled) Gene loadings of macrophage genes for each component", scale="row")
```
...
aheatmap(t(results$loadings[[1]][,leydig_genes]), breaks=0, Colv = NA, cexRow = 0.2, layout = "_*", main="(row scaled) Gene loadings of acrosomal genes for each component", scale="row")
```
...
tmp <- datat[,c("cell","Tsne1_QC1", "Tsne2_QC1","PseudoTime"), with=FALSE]
...
```{r, fig.width=6}
ggplot(datat, aes(Tsne1, Tsne2, color=V10)) +
  geom_point(size=1) +
  scale_color_viridis(direction=-1) +
...
ggplot(datat, aes(Tsne1, Tsne2, color=Edn1)) +
  geom_point(size=1) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime") +
...
ggplot(datat, aes(Tsne1, Tsne2, color=Kazald1)) +
  geom_point(size=1) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime") +
...
ggplot(datat, aes(Tsne1, Tsne2, color=Cdo1)) +
  geom_point(size=1) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime") +
...
ggplot(datat, aes(Tsne1, Tsne2, color=Plac1)) +
  geom_point(size=1) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime") +
