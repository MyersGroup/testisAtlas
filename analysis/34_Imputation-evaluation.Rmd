...
load("../data/imputation/imputed_ranks.rds")
...
```{r}
png(width = 1500*1.7, height = 1500, res = 300, file = "../results/imputation/imputationAUC_cellwise.png")
plot_grid(plot_train, lib_size_plot)
dev.off()

png(width = 1500*1.7, height = 1500, res = 250, file = "../results/imputation/imputationAUC_average.png")
plot_grid(plot_mean, c2)
dev.off()
```
