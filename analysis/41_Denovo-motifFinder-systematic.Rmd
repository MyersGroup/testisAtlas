...
matched_pwms <- plot_motif_matches(best_denovo,
                                   titles=c("Sp2","Nfya","Zfp143","Rfx2","Nrf1","Gabpa","Spi1","Crem","Etv5","Zfp42","Mlx","Stat1","Tbp","Mybl1","Atf1*","Taf1*"))
...
y_pos = 0.82
wh <- 0.16
#icons <- c("TI","N","TL","TI","I","N","I","T2I","TI","T","TL","TL","N","I","N")
...
# pdf(height=12, width=15, file="../results/motifs_test.pdf")
# plot_grid(NULL, NULL, NULL, plot_grid(plotlist=tmp, ncol=3), labels = c("", "C", "D", "E"), ncol = 2, label_size=16, rel_heights = c(1.1,1))
# dev.off()

pdf(height=5, width=10, file="../results/motifs_fig_A.pdf")
