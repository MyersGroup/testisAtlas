...
c83_rug_plot <- ggplot(tmp, aes(rank, loading,colour=KO)) +
  geom_point(colour="black") +
  geom_rug(data=tmp[gene %in% Trip13KO$V1], sides = "b", size=0.2) +
  geom_rug(data=tmp[gene %in% Hormad1KO_genes], sides = "t", size=0.2) +
  ylab("Component 38 Gene Loading") + xlab("Rank of gene by loading") +
  scale_color_brewer(palette = "Set1")+
  guides(colour = guide_legend(override.aes = list(size=5))) +
  theme(legend.position = c(0.7,0.7)) + labs(colour="KO DE Genes")

c83_rug_plot

saveRDS(c83_rug_plot, "../data/tmp_cache/c83_rug_plot.rds")
...
hormad1_enrich$KO <- "Enrichment of Hormad1 KO DE Genes"
trip13_enrich$KO <- "Enrichment of Trip13 KO DE Genes"

trip13_enrich <- rbind(trip13_enrich, hormad1_enrich)

trip13_enrich_plot <- ggplot(trip13_enrich, aes(Component, -log(p.value,10), label=paste0(Component," - ",name))) +
  geom_point(aes(colour=Type)) +
  geom_label_repel(data=trip13_enrich[p.value<1e-20], ylim=c(30,140), force = 20, nudge_y = -20) +
...
saveRDS(trip13_enrich_plot, "../data/tmp_cache/trip13_enrich_plot.rds")
...
```{r, fig.width=6}
ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=asinh(V25))) +
  geom_point(size=0.5) +
...
ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=`Rps13-ps1`)) +
  geom_point(size=0.5) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime")

ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=Hist1h2al)) +
  geom_point(size=0.5) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime")

ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=Gm10036)) +
  geom_point(size=0.5) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime")

ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=Jakmip2)) +
  geom_point(size=0.5) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime")

ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=Tagln2)) +
  geom_point(size=0.5) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime")

ggplot(datat, aes(Tsne1_QC1, Tsne2_QC1, color=Lpo)) +
  geom_point(size=0.5) +
  scale_color_viridis(direction=-1) +
  theme(legend.position = "bottom") +
  ggtitle("t-SNE - cells coloured by PseudoTime")
